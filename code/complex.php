...
$stmt = $pdo->prepare("SELECT recipes.*, users.nickname AS user_nickname, users.avatar AS user_avatar FROM recipes JOIN users ON recipes.user_id = users.id WHERE recipes.type = 'complex'");
$stmt->execute();
...
<body>
    ...
    <div class="sub-header">
        <h1 class="title">Сложные Рецепты</h1>
